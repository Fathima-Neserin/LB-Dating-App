...
function SendOTP({ separator, length, value, onChange }) {
...
export default function OTPInput() {
  ...
  const verifyHandle = () => {
    ...
    axios.post("http://localhost:3001/oauth/verifyotp",{ phoneNumber, userOTP: otp })
    .then((res) =>{
  ...
  return (
    ...
    >
      ...
      <br/><br/>
      <Button style={{marginLeft: "30%"}} id='btn' variant='contained' onClick={verifyHandle}>Verify</Button>
